...
const ExploreAll = () => {
  ...
  const currentCars = sortedData.slice(indexOfFirst, indexOfLast);
    ...
    <div className='py-20 px-4 sm:px-6 md:px-10'>
      <div className='flex justify-between items-center'>
        ...
        <p 
          ...
          className='cursor-pointer underline text-blue-500 hover:text-blue-700 transition'
        >
          {filter ? 'Default Order' : 'Sort: Low to High'}
        </p>
      </div>
